...
class AuthViewSets(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
           ...
           'Confirmation code for account verification',
            ...
            return Response({"success":True,"message":"Account created successfully , check your email to continue the verification process ","data":serializer.data},status= status.HTTP_201_CREATED  )
    ...
    def activate_account(self,request, *args, **kwargs):
       ...
       if (user.token == request.data['token']):
             ...
             return  Response({"succes":True,"data":serializer.data},status=status.HTTP_200_OK)

       return  Response(data={"success":False,'message':'verification failed'},status=  status.HTTP_400_BAD_REQUEST)
